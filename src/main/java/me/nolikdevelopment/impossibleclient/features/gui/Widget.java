package me.nolikdevelopment.impossibleclient.features.gui;
...
import me.nolikdevelopment.impossibleclient.features.gui.items.buttons.Button;
import me.nolikdevelopment.impossibleclient.features.modules.client.ClickGui;
import me.nolikdevelopment.impossibleclient.util.ColorUtil;
import me.nolikdevelopment.impossibleclient.util.render.RenderUtil;
import me.nolikdevelopment.impossibleclient.util.render.ScissorUtil;
...
public class Widget
    ...
    public void drawScreen(GuiGraphics context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) ImpossibleGui.getClickGui().getTextOffset(), -1);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            ImpossibleGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
