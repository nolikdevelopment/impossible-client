...
import me.nolikdevelopment.impossibleclient.features.gui.items.buttons.ModuleButton;
...
public class ImpossibleGui extends Screen {
    private static ImpossibleGui INSTANCE;
    private static Color colorClipboard = null;

    static {
        INSTANCE = new ImpossibleGui();
    }

    private final ArrayList<Widget> widgets = new ArrayList<>();

    public ImpossibleGui() {
        super(Component.literal("impossible"));
        setInstance();
        load();
    }

    public static ImpossibleGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new ImpossibleGui();
        }
        return INSTANCE;
    ...
    public static ImpossibleGui getClickGui() {
        return ImpossibleGui.getInstance();
    }
